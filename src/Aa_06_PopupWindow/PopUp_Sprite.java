...
public class PopUp_Sprite {
    ...
    private int speed = 12;   // ANIMATION SPEED
    private int counter = 0;   // FOR TIMING
    private double scale = 4; // SPRITESHEET SCALING - NO BLUR
    
    public PopUp_Sprite(BufferedImage spriteSheet, int frameWidth, int frameHeight, int totalFrames, int x, int y) {
